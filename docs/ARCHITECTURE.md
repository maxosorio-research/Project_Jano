...
For 0.1, the Markdown/text representation is generated by Jano's own local
pipeline and retains segment IDs. Externally supplied translations are not a
supported reader input; their normalization and alignment are a post-0.1
boundary described by ADR 0013.
